...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // Match Input brand defaults exactly
        "flex w-full items-center justify-between gap-2 whitespace-nowrap",
        "h-12 rounded-[var(--ds-radius-inner)] px-4 text-sm",
        "bg-background",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          // Brand: inner radius + visible border + shadow
          "rounded-[var(--ds-radius-inner)] border-2 border-[var(--ds-border-brutalist)] shadow-[var(--ds-shadow-hover)] backdrop-blur-sm",
          position === "popper" &&
